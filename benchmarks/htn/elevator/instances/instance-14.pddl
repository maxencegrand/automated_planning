...
(:init
	...
	(origin passenger_2 floor_3)
	(origin passenger_3 floor_0)
	(origin passenger_4 floor_7)
	(origin passenger_5 floor_1)
	(origin passenger_6 floor_1)
	(origin passenger_7 floor_3)
	(origin passenger_8 floor_4)
	(origin passenger_9 floor_4)
	(origin passenger_10 floor_7)
	(origin passenger_11 floor_6)
	(origin passenger_12 floor_3)
	(origin passenger_13 floor_7)
	(origin passenger_14 floor_7)
	(destin passenger_0 floor_4)
	(destin passenger_1 floor_0)
	(destin passenger_2 floor_7)
	(destin passenger_3 floor_3)
	(destin passenger_4 floor_3)
	(destin passenger_5 floor_3)
	(destin passenger_6 floor_6)
	(destin passenger_7 floor_2)
	(destin passenger_8 floor_6)
	(destin passenger_9 floor_0)
	(destin passenger_10 floor_2)
	(destin passenger_11 floor_7)
	(destin passenger_12 floor_1)
	(destin passenger_13 floor_0)
	(destin passenger_14 floor_0)
)
(:goal (and
	(served passenger_0)
	(served passenger_1)
