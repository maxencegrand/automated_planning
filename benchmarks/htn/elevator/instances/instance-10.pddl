...
(:init
	...
	(origin passenger_0 floor_12)
	(origin passenger_1 floor_7)
	(origin passenger_2 floor_13)
	(origin passenger_3 floor_13)
	(origin passenger_4 floor_8)
	(origin passenger_5 floor_6)
	(origin passenger_6 floor_4)
	(origin passenger_7 floor_7)
	(destin passenger_0 floor_1)
	(destin passenger_1 floor_2)
	(destin passenger_2 floor_8)
	(destin passenger_3 floor_9)
	(destin passenger_4 floor_0)
	(destin passenger_5 floor_10)
	(destin passenger_6 floor_10)
	(destin passenger_7 floor_14)
)
(:goal (and
	(served passenger_0)
	(served passenger_1)
